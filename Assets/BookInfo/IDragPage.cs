...
namespace HKZ
{
    ...
    public abstract class DragPageBase
    {
        ...
        public DragPageBase(BookManager bookManager, BookModels bookModels,
            TheDraggingPage frontPage, TheDraggingPage backPage, Vector3 startPos)
        {
            ...
            clippingMask = bookManager.GetClippingMask();
        }
        /// <summary>
        /// 开始拖拽
        /// </summary>
        ...
        {
            bookModels.ClickPoint = bookManager.GetClickPos();

            backPage.SetParent(clippingMask, true);
            frontPage.SetParent(bookManager.transform, true);

            bookModels.CurrentPageCorner = bookManager.CulculateDraggingCorner(bookModels.ClickPoint);
        ...
        private Vector3 UpdateClippingMask()
        {
            ...
            float angle = bookManager.CulculateFoldAngle(bookModels.CurrentPageCorner, GetBookCorner(), out bottomCrossPoint);
            if (angle > 0)
            {
                angle = angle - 90;
            }
        ...
        {
            backPage.transform.position = bookManager.Local2WorldPos(bookModels.CurrentPageCorner);
        ...
        public void EndDragPage(Action complete)
        {
            ...
            bookManager.FlipAni(corner, complete);
        }
    }
}
